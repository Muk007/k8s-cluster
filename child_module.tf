...
module "s3" {
  source = "./s3"
  # Vpc_name is basically your name or surname to keep resources unique in aws. You should chnage 'gaurav' to 'your-name'.
  # 'gaurav' will be taken as prefix for your cluster name also, 'gaurav.k8s' in this case.
  vpc_name = "gaurav"
}
